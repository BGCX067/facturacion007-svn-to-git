...
<div class="block_head">
        ...
        <ul class="tabs">
          ...
          <ul>
            <li>
                <form>
                    <label for="clientes">Buscar:</label><input class="text" type="text" id="clientes" value="" >
                </form>
            </li>
        </ul>
    </div>
...
?>
   <tr>
        ...
        <td class="options">
            ...
            <a class="tip" title="Eliminar" href="#" onclick="eliminarCliente(<?php echo $value['id'] ?>)"><img  src="<?php echo URL; ?>public/images/bdelete.png" alt="Eliminar" /></a>
        </td>
