...
<div class="block_head">
        ...
        <ul class="tabs">
         ...
         <ul>
            <li>
                <form>
                    <label for="productos">Buscar:</label><input class="text" type="text" id="productos" value="" >
                </form>
            </li>
        </ul>
    </div>
