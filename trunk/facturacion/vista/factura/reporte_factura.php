...
$cabecera='<table>
                <tr>
                    <td style="width:300px; "><img src="public/images/logo.JPG" alt="test alt attribute" border="0" width="150px" height="150px" /></td>
                    <td>
                    <table>
                        <tr>
...
foreach ($this->productos as $value) {
    $html.='<tr style="border: 1px solid #DDDDDD;line-height: normal;">
                ...
                <td style="border: 1px solid #DDDDDD;line-height: normal;">'.$value['descripcion'].'</td>
