...
class Proveedor_Model extends Modelo {
    ...
    public function listarProveedores() {
       ...
       $consulta = $this->db->ejecutarConsulta('SELECT id, rif, razon_social, telefono FROM proveedores') ;
...
//               FROM proveedores p
//               WHERE p.id= :id';
       $consulta = $this->db->ejecutarConsulta('SELECT id, rif, razon_social, telefono FROM proveedores where id='.$id) ;
    ...
    public function eliminar($id) {
        ...
        $this->db->ejecutarConsulta($sql,array(':id' => $id));
    }
